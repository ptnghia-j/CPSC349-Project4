function githubSvg () {
  return (
    <a href="" className="text-gray-500 hover:text-green-100 hidden xl:block">
      <svg
        className="h-5 w-5"
        fill="currentColor"
        viewBox="0 0 24 24"
...
function FooterBar() {
  return (
    ...
    <div class="bottom-10 left-10 text-center text-sm text-gray-500 hidden xl:block">
    &copy; 2022 <a href="https://themesberg.com" class="hover:underline" target="_blank">Group 11</a>. All rights reserved.</div>

    <div class="bottom-10 right-10 flex justify-center space-x-6">
        <p class="interactive_hidden">Clay Golan</p>
        {githubSvg()}
        <p class="interactive_hidden">Geoffrey Mendoza</p>
        {githubSvg()}
        <p class="interactive_hidden">Indrajeet Patwardhan</p>
        {githubSvg()}
        <p class="interactive_hidden">Nghia Phan</p>
        {githubSvg()}
    </div>
    </footer>
  )
